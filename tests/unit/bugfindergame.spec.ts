...
describe('bugfindergame.ts', () => {
  ...
  beforeEach(() => {
    ...
    jest.clearAllMocks();
    codes = [
      new Code("code-1", [new Word("word-1-1", "prublic"), new Word("word-1-2", " "), new Word("word-1-3", "void"), new Word("word-1-4", "hello()")]),
      new Code("code-2", [new Word("word-2-1", "public"), new Word("word-2-2", " "), new Word("word2-3", "void"), new Word("word-2-4", "bye()")])
    ];
    const codesResponse = {
      data: codes
    };
